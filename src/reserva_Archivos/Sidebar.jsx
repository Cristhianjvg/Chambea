                  ...
                  return (
                    <React.Fragment>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-9 mt-1 ${!open && 'hidden'}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink end to="/onboarding-01" className="block truncate transition duration-150 text-slate-400 hover:text-slate-200">
                              <span className="text-sm font-medium duration-200 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100">
                                Step 1
                              </span>
                            </NavLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink end to="/onboarding-02" className="block truncate transition duration-150 text-slate-400 hover:text-slate-200">
                              <span className="text-sm font-medium duration-200 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100">
                                Step 2
                              </span>
                            </NavLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink end to="/onboarding-03" className="block truncate transition duration-150 text-slate-400 hover:text-slate-200">
                              <span className="text-sm font-medium duration-200 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100">
                                Step 3
                              </span>
                            </NavLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink end to="/onboarding-04" className="block truncate transition duration-150 text-slate-400 hover:text-slate-200">
                              <span className="text-sm font-medium duration-200 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100">
                                Step 4
                              </span>
                            </NavLink>
