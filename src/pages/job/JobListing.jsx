  ...
  const items = [
    {
      ...
      link: '/job/job-post',
      details: 'Medio Tiempo / Remoto / Guayaquil, EC',
      date: 'Enero 4',
      type: 'Featured',
      fav: false,
    },
    {
      ...
      image: Image01,
      company: 'Company 02',
      role: 'Diseñadora senior de aplicaciones web',
      link: '/job/job-post',
      details: 'Contract / Remote / Quito, EC',
      date: 'Jan 7',
      type: 'New',
      fav: true,
    },
    {
      ...
      link: '/job/job-post',
      details: 'Contract / Remote / Cuenca, EC',
      date: 'Jan 7',
      type: 'New',
      fav: false,
    },
    {
      ...
      link: '/job/job-post',
      details: 'Tiempo Completo / Remote / Loja, EC',
      date: 'Jan 7',
      type: 'New',
      fav: false,
    },
    {
      ...
      link: '/job/job-post',
      details: 'Full-time / Remote / Ambato, EC',
      date: 'Jan 6',
      type: 'New',
      fav: true,
    },
    {
      ...
      link: '/job/job-post',
      details: 'Medio Tiempo / Remote / Carchi, EC',
      date: 'Jan 6',
      type: 'New',
      fav: false,
    },
    {
      ...
      link: '/job/job-post',
      details: 'Freelance / Remote / Machala, EC',
      date: 'Jan 6',
      type: 'New',
      fav: false,
    },
    {
      ...
      image: Image04,
      company: 'Company 08',
      role: 'Asistente de Finanzas',
      link: '/job/job-post',
      details: 'Contract / Remote / Zamora Chinchipe, EC',
      date: 'Jan 6',
      type: 'New',
      fav: false,
    },
    {
      ...
      image: Image05,
      company: 'Company 09',
      role: 'Editor de Video Junior',
      link: '/job/job-post',
      details: 'Full-time / Remote / Napo, EC',
      date: 'Jan 5',
      type: 'New',
      fav: false,
    },
